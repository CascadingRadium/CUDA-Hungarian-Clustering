...
<p float="left">
  <img src="TestedDatasets/data0.png" width="33%" title="data0.csv" alt="data0">
  <img src="TestedDatasets/data1.png" width="33%" title="data1.csv" alt="data1">
  <img src="TestedDatasets/data2.png" width="33%" title="data2.csv" alt="data2">
</p>
<p float="left">
  <img src="TestedDatasets/data3.png" width="33%" title="data3.csv" alt="data3">
  <img src="TestedDatasets/data4.png" width="33%" title="data4.csv" alt="data4">
  <img src="TestedDatasets/data5.png" width="33%" title="data5.csv" alt="data5">
</p>
<p float="left">
